...
export default function MyCertificatesPage() {
  ...
  useEffect(() => {
    if (!loading && !userData) router.push("/login?redirect=/profile/certificates");
  ...
  return (
    <>
      <NoticeBar />
      <Navbar />
      <main className="container mx-auto px-4 md:px-10 py-12 max-w-4xl">
        ...
        <p className="text-sm text-muted-foreground mb-8">Certificates earned from completed courses and event participation.</p>
